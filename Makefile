...
ifeq ($(USE_OPT),)
  USE_OPT = -std=c99 -O2 -fno-inline-small-functions -ggdb -fomit-frame-pointer -falign-functions=16 --specs=nano.specs -fstack-usage -Wno-unused-parameter
endif
...
UDEFS = -DSHELL_CMD_TEST_ENABLED=FALSE -DSHELL_CMD_MEM_ENABLED=FALSE -DARM_MATH_CM0 -DM_PI=3.1415926535897932384626433832795 -DVERSION=\"$(VERSION)\"
